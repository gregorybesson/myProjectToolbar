...
var serverUrl = 'http://toolbarhost.domain/toolbar/';
...
function takeScreenShot(){
	var code = prompt("Saisissez le code projet : ", "");
	var issue = prompt("Decrivez l'incident : ", "");
	...
	html2canvas(window.parent.document.body).then(function(canvas) {
		...
		var canvasData = canvas.toDataURL("image/png");
			canvasData += "&code=" + code + "&summary=" +encodeURIComponent(unescape(issue))+"&url="+encodeURIComponent(document.URL);
